/*
 * modbus_ascii_device.cpp
 *
 *  Created on: Jul 15, 2022
 *      Author: r2h
 */
#include <unistd.h>
#include "modbus_ascii_device.hpp"

namespace serial_port_device
{
ModbusAsciiDevice::ModbusAsciiDevice(ModbusAsciiProtocol *protocol, r2h_uint8 unit,
...
void ModbusAsciiDevice::ProcessDataSize(r2h_byte instance, r2h_uint16* production, r2h_uint16* consume)
{
	*production = __rsize*2;
	*consume = __wsize*2;
}

void ModbusAsciiDevice::WriteConfigure(r2h_byte instance, r2h_byte devIndex, r2h_uint16 productionStart, r2h_uint16 consumeStart)
{
	_instance = instance;
	_dev_index = devIndex;
...
void ModbusAsciiDevice::ReadConfiguration(r2h_byte *instance, r2h_byte *devIndex, r2h_uint16 *productionStart, r2h_uint16 *consumeStart)
{
	if(instance != nullptr)
		*instance = _instance;
	if(devIndex != nullptr)
...
r2h_uint16 ModbusAsciiDevice::ExchangeDataWithDevice(GenericSharedMemory &productionMem, GenericSharedMemory &consumeMem,
